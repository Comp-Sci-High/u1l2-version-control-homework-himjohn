...
let versionControlExplanation = "track your changes and checkpoints ";
...
// Write your answer as a string and store it in the variable below:
let gitRepoExplanation = " repository stores your code";
...
let versionControlBenefits = [you can go back to your code];
...
let stepsToPushChanges = [first you gotta use git add then use git commit to name the update you gon give to then , use push to put everything on the repo.];
